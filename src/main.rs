...
fn main() {
    ...
    light_group.add(Light::new([-8.0, 8.0, -6.0].into(), 1.0, [1.0, 1.0, 1.0].into()));
    ...
    //render
    let renderer = Renderer::new(world, light_group, camera, Shader::Phong);
